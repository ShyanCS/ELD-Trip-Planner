...
│   ├── requirements.in              # Direct dependencies (human-edited source of truth)
│   ├── requirements.lock            # Pinned lockfile — regenerate with pip-compile
│   ├── manage.py
│   ├── config/
...
# Install Python dependencies from the lockfile (reproducible)
...
- `requirements.in` — unpinned direct dependencies (source of truth; edit this)
- `requirements.lock` — fully-pinned lockfile generated by `pip-compile requirements.in --output-file requirements.lock --no-header`
